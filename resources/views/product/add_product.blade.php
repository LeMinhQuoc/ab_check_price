...
<body>
  ...
  <main>
    ...
    <img style="height: auto; width: auto; margin-right: auto;" src="{{ asset('image/ab_logo.png') }}" alt="AB Logo">
    <button id="showPopup" style="margin-left: 90%;" class="btn btn-secondary">Thêm Sản Phẩm</button>
